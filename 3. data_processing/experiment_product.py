...
# eliminar clientes con mas de un pedido en la ultima fecha para evitar ambiguedades (es solo el 0.76% de los clientes)
...
f_tendencias = df_last3.join(
    f_valores.select("cliente_id", "facturacion_prom", "materiales_prom", "cajas_fisicas_prom"),
    "cliente_id",
    "left"
)
